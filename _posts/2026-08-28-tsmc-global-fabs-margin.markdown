---
layout: post
title: '台积电：净利润增长 77%，全球扩产会稀释 68% 毛利率吗'
author: 'Felix Yang'
...
台积电在 2026 年第二季度取得 1.27 万亿新台币收入，同比增长 36.0%；净利润却增长 77.4%，达到 7066 亿新台币。毛利率升至 67.7%，经营利润率达到 60.3%。晶圆卖得更多只是第一层变化，更先进的制程、更高的工厂利用率和客户急于取得产能，让利润跑得比收入快得多。

这也是最容易被直线外推的时刻。AI 芯片客户需要更多 3 纳米、2 纳米晶圆和先进封装，台积电则在多个地区建设价格昂贵的新厂。当前稀缺性正在产生很高利润，扩产又会增加折旧、人员与供应链成本。问题不是 AI 芯片是否还会增长，而是台积电能否把今天的稀缺利润带进一个更分散、更昂贵的制造网络。
...
台积电已经把先进制程稀缺性变成收入和利润，下一步要证明的是，新工厂加入之后，客户仍愿意把最重要的设计按时推入量产。最先改变判断的事件，是大型 AI 客户的下一代加速器从试产进入规模交付。

如果这次量产按计划发生，2 纳米与先进封装占比继续提高，同时毛利率在海外扩产中保持接近指引，说明客户绑定、良率和价格足以覆盖更昂贵的制造网络。若客户推迟量产、转向第二来源，或者产品上市而毛利率持续下滑，AI 需求仍可能强劲，台积电为这份需求修建的全球产能却会先暴露成本。
