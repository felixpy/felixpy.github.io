---
layout: post
title: 'ASML：收入增长 17%，光刻机垄断为什么没有立刻变成现金'
author: 'Felix Yang'
...
ASML 在 2026 年上半年取得 180.93 亿欧元收入，同比增长 17.2%，经营利润也升至 61.25 亿欧元。可同一时期，经营现金流从上年同期的 12.87 亿欧元变成负 4.82 亿欧元。公司一边把全年收入预期上调至 430 亿至 450 亿欧元，一边准备把 2027 年低数值孔径 EUV 和 DUV 浸没式光刻机产能各增加 30%。

这组数字让一个看似简单的垄断故事变得复杂。AI 芯片对先进制程的需求越强，晶圆厂越离不开 ASML；但订单、系统验收、收入和收款并不会同时发生。技术控制力已经很清楚，尚待回答的是，它能否在加速扩产时继续变成高质量现金，而不被研发、供应链和客户交付节奏拖住。
...
ASML 已经给出了最清楚的验证时间点。2027 年，计划增加的低数值孔径 EUV 与 DUV 浸没式产能开始进入交付节奏。届时不必只数机器，应沿同一批系统查看四件事：收入是否按验收确认，服务收入是否随安装基数扩大，毛利率是否承受住新平台爬坡，现金是否从应收与合同项目中回来。

如果四者同向，2026 年上半年的负经营现金流更像交付和预付款周期造成的错位，扩产也在把技术控制力转成持续盈利。若机器数量增加，研发和应收继续更快上升，现金却迟迟不回，垄断仍然存在，但它兑现为股东经济收益的速度会低于当前价格所要求的节奏。
