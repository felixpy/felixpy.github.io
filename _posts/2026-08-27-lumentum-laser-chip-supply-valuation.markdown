---
layout: post
title: 'Lumentum：收入增长 83%，激光芯片短缺能撑住 27 倍收入估值吗'
author: 'Felix Yang'
...
Lumentum 在 2026 财年取得 30.14 亿美元收入，比上一年增长 83.2%。毛利率也从 28.0% 升到 41.7%，经营利润由亏转盈。AI 数据中心需要的激光芯片和光学组件不只卖得更多，工厂更高的利用率还让每一美元收入留下了更多毛利。

供给紧张通常听起来像最理想的增长故事，公司甚至要在订单之间分配产能。但 Lumentum 同期把库存增加到 6.916 亿美元，资本开支升至 4.513 亿美元，最大客户的收入占比又从 15.4% 跳到 26.6%。当股价已经为持续扩张支付很高价格时，问题不再是光互连有没有需求，而是扩出来的工厂究竟服务于一个长期市场，还是少数客户的一轮集中采购。
...
Lumentum 已经证明激光芯片短缺能带来收入、毛利和经营现金，尚未证明的是，供给增加之后还能保留多少议价权。最先改变判断的事件，应是最大客户下一轮产品采购如何落地。

如果扩产完成后，最大客户收入继续增长，同时其他客户与系统业务更快放量，集中度下降而工厂利用率保持稳定，当前短缺正在变成更宽的商业基础。若最大客户占比继续上升，库存和资本开支也随之增加，增长仍然真实，只是 Lumentum 会把更多资产交给一个客户的采购节奏决定。
