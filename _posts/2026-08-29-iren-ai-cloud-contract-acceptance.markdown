---
layout: post
title: 'IREN：AI 云收入增长近 7 倍，130 亿美元合同要先跨过验收'
author: 'Felix Yang'
...
2026 年 8 月，IREN 把 Horizon 1 数据中心交给 Microsoft 并通过验收。这是双方约 97 亿美元合同中的第一批设施，其余 Horizon 2 至 4 计划在 2026 年第四季度分阶段交付，合同宽限期最晚延伸到 2027 年第二季度初。对一家上一财年 AI 云收入只有 1.288 亿美元的公司而言，一批机房是否按时通电、装好 GPU 并被客户接受，会决定数十亿美元投入何时开始产生收入。

合同规模已经把 IREN 推进大型 AI 基础设施供应商的队列。2026 财年，它的 AI 云收入从 1640 万美元增至 1.288 亿美元，接近上一年的 7.9 倍；但公司同期资本开支接近 30 亿美元，净亏损 7.026 亿美元。眼前的矛盾不是有没有客户，而是 IREN 能否在客户合同、设备采购、项目融资和工程交付之间保持同一个节奏。
...
下一次最能改变判断的不是新合同公告，而是 Horizon 2 至 4 的验收。目标窗口从 2026 年第四季度延伸到 2027 年第二季度初，这给研究留下了一个明确时间点。

三批设施若按期交付，AI 云收入开始接近合同规模所暗示的速度，IREN 就证明了 Horizon 1 不是一次性项目，而是一套可以复制的工程与融资流程。若验收连续推迟，经营现金仍可能因预付款而好看，合同总额也不会立刻消失，但折旧、债务和新增股份会先把等待的成本写进报表。
