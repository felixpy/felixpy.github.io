---
layout: post
title: 'Coherent：数据中心收入增长 40%，光互连为何还没变成现金'
author: 'Felix Yang'
...
Coherent 在 2026 财年取得 71.18 亿美元收入，比上一年增长 23%。其中数据中心与通信业务收入增长 40%，达到 52.75 亿美元，分部利润也增长 47%。光互连已经从 AI 概念变成了货物和收入。

现金却没有跟上。经营现金流从 6.34 亿美元降至 7950 万美元，厂房与设备投入由 4.41 亿美元增加到 11.03 亿美元。两项简单相减，当年自由现金流约为负 10.23 亿美元。问题不再是 AI 集群是否需要更多光，而是 Coherent 为材料、芯片、收发器和新产能提前付出的钱，能否在客户换代结束后回来。
...
Coherent 已经证明 AI 光互连能带来收入，也在毛利和分部利润中显示了规模效应。尚未完成的是从需求预测、备料、扩产、出货到回款的最后一段。

下一财年最先改变判断的信号，是经营现金流能否重新覆盖更大比例的资本开支。如果库存增长放缓，收入与分部利润继续增加，现金开始从生产线上回来，2026 年的负自由现金流更像扩产的时间差。若资本开支维持高位，经营现金流仍接近零，光互连需求即使真实，Coherent 也仍在用自己的资产负债表替客户承担交付时间。
